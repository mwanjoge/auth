    ...
    <header class="navbar navbar-expand-md navbar-dark d-print-none">
        <div class="container-fluid">
            ...
            <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                <a href=".">
                    <img src="{{asset('images/logo.svg')}}" width="110" height="32" alt="{{env('APP_NAME')}}" class="navbar-brand-image" />
                </a>
            </h1>
            <div class="navbar-nav flex-row order-md-last">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                        <span class="avatar avatar-sm" style="background-image: url({{asset('images/avatars/avatar.png')}})"></span>
                        <div class="d-none d-xl-block ps-2">
                            @if(auth()->check())
                                <div>{{Auth()->user()->name}}</div>
                                <div class="mt-1 small text-muted text-capitalize">{{auth()->user()->roles->first()?->name}}</div>
                            @endif
                        </div>
                    </a>
